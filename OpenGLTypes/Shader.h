...
{
public:
    Shader(const char* VertexShaderFilePath, const char* FragmentShaderFilePath, const char* LightCalculationFilePath = "");
...
private:
    bool LoadShaderFromFile(const char* ShaderFilePath, std::string& OutShaderCode);
    
    bool LoadShaderFromFile(const char* ShaderFilePath, const char* LightFilePath, std::string& OutShaderCode);
